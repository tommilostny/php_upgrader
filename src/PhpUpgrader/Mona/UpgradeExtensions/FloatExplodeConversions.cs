...
public static partial class FloatExplodeConversions
{
    ...
    [GeneratedRegex(@"\s\$stranka_end = \$stranka_pocet \/ 10;\s+\$stranka_end = explode\(""\."", \$stranka_end\);\s+\$stranka_end = \$stranka_end\[0\];\s+\$stranka_end = \$stranka_end \* 10 \+ 10;", RegexOptions.None, matchTimeoutMilliseconds: 1234)]
